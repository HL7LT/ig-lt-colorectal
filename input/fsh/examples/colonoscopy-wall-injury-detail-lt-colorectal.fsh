...
InstanceOf: ColonoscopyWallInjuryDetailLtColorectal
Usage: #example
...
* component[sydneyClassification].valueCodeableConcept = SydneyClassificationCS#type-3 "Sydney DMI Type III"
...
* effectiveDateTime = "2026-03-12"
* component[sydneyClassification].code = $sct#303078007 "Perforation of large intestine (disorder)"
* component[sydneyClassification].valueCodeableConcept = SydneyClassificationCS#type-4 "Sydney DMI Type IV"
* component[actionTaken].code = $sct#129271007 "Management - action (qualifier value)"
...
* effectiveDateTime = "2026-03-12"
* component[sydneyClassification].code = $sct#303078007 "Perforation of large intestine (disorder)"
* component[sydneyClassification].valueCodeableConcept = SydneyClassificationCS#type-5 "Sydney DMI Type V"
* component[actionTaken].code = $sct#129271007 "Management - action (qualifier value)"
