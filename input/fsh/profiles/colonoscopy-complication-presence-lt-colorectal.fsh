Profile: ColonoscopyComplicationPresenceLtColorectal
Parent: ObservationLt
Id: colonoscopy-complication-presence-lt-colorectal
Title: "Colonoscopy Complication Presence (LT Colorectal)"
...
* value[x] 1..1 MS
* valueCodeableConcept from ColonoscopyComplicationPresenceVS (required)
