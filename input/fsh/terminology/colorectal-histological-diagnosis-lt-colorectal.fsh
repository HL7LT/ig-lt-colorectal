ValueSet: ColorectalHistologicalDiagnosisVS
Id: colorectal-histological-diagnosis
Title: "Colorectal Histological Diagnosis"
Description: "Histological diagnosis categories for pathological examination in the colorectal cancer screening program."
* ^url = $colorectal-histological-diagnosis-vs-url
* ^status = #active
* ^experimental = false
...
* $sct#61722000 "Tubulovillous adenoma (morphologic abnormality)"
* $sct#128859003 "Villous adenoma (morphologic abnormality)"

// Serrated polyps
* $sct#62047007 "Hyperplastic polyp (morphologic abnormality)"
* $sct#443157008 "Sessile serrated adenoma (morphologic abnormality)"
* $sct#783210009 "Sessile serrated adenoma with dysplasia (morphologic abnormality)"
* $sct#443734007 "Traditional serrated adenoma (morphologic abnormality)"

// Other polyps
* $sct#41329004 "Polyp (morphologic abnormality)"
...
// Malignant tumors - Primary carcinoma
* $sct#1187332001 "Adenocarcinoma (morphologic abnormality)"
* $sct#72495009 "Mucinous adenocarcinoma (morphologic abnormality)"
* $sct#87737001 "Signet ring cell carcinoma (morphologic abnormality)"
* $sct#32913002 "Medullary carcinoma (morphologic abnormality)"
* $sct#450948005 "Serrated adenocarcinoma (morphologic abnormality)"
* $sct#733878002 "Micropapillary adenocarcinoma (morphologic abnormality)"
...
* $sct#23109009 "Pseudosarcomatous carcinoma (morphologic abnormality)"
